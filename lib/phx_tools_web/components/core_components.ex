defmodule PhxToolsWeb.CoreComponents do
  ...
  def os_link_card(assigns) do
    ...
    <.link patch={@href}>
      <div
        id={@id}
        class={[
          "block border-2 border-indigo-650 py-2 rounded-md cursor-pointer hover:bg-indigo-850",
          @class
        ]}
      >
        <img src={@os_icon} />
  ...
  def flash(assigns) do
    ...
    <div
      ...
      {@rest}
    >
      <p :if={@title} class="flex items-center gap-1.5 text-1xs font-semibold leading-6">
